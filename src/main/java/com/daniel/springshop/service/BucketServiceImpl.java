...
import com.daniel.springshop.dao.BucketRepository;
...
import com.daniel.springshop.dto.BucketDetailsDTO;
...
public class BucketServiceImpl implements BucketService{
    ...
    public Bucket createBucket(User user, List<Long> productIds) {
        ...
        bucket.setUser(user);
        List<Product> productsList = getCollectRefProductsByIds(productIds);
    ...
    public BucketDTO getBucketByUser(String name) {
        ...
        for (Product product : products) {
            BucketDetailsDTO detail = mapProductId.get(product.getId());
            if ((detail == null)) {
                mapProductId.put(product.getId(), new BucketDetailsDTO());
